  ...
  return (
    <>
      <div className='text-center flex justify-center pt-10'>
        <h2 className='bg-white w-60 h-10 text-red-600 rounded-full flex justify-center items-center'>
      ...
      <div className='pt-8 text-center items-center w-[40%] shadow-lg mx-auto flex'>
        <input 
          ...
          className='outline-none h-9 rounded-l-full border-none w-full pl-4 text-black' 
        />
